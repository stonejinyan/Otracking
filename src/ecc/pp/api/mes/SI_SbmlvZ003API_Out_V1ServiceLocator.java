/**
 * SI_SbmlvZ003API_Out_V1ServiceLocator.java
 *
...
public class SI_SbmlvZ003API_Out_V1ServiceLocator extends org.apache.axis.client.Service implements ecc.pp.api.mes.SI_SbmlvZ003API_Out_V1Service {

    public SI_SbmlvZ003API_Out_V1ServiceLocator() {
    }


    public SI_SbmlvZ003API_Out_V1ServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public SI_SbmlvZ003API_Out_V1ServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTPS_Port
    private java.lang.String HTTPS_Port_address = "https://ppoweb.cn.schneider-electric.com:50001/XISOAPAdapter/MessageServlet?senderParty=&senderService=BC_SEEE_MES&receiverParty=&receiverService=&interface=SI_SbmlvZ003API_Out_V1&interfaceNamespace=http%3A%2F%2Fecc%2Fpp%2Fapi%2Fmes";
    ...
    public ecc.pp.api.mes.SI_SbmlvZ003API_Out_V1 getHTTPS_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ecc.pp.api.mes.SI_SbmlvZ003API_Out_V1BindingStub _stub = new ecc.pp.api.mes.SI_SbmlvZ003API_Out_V1BindingStub(portAddress, this);
    ...
    private java.lang.String HTTP_Port_address = "http://ppoweb.cn.schneider-electric.com:50000/XISOAPAdapter/MessageServlet?senderParty=&senderService=BC_SEEE_MES&receiverParty=&receiverService=&interface=SI_SbmlvZ003API_Out_V1&interfaceNamespace=http%3A%2F%2Fecc%2Fpp%2Fapi%2Fmes";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ecc.pp.api.mes.SI_SbmlvZ003API_Out_V1.class.isAssignableFrom(serviceEndpointInterface)) {
                ecc.pp.api.mes.SI_SbmlvZ003API_Out_V1BindingStub _stub = new ecc.pp.api.mes.SI_SbmlvZ003API_Out_V1BindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
            if (ecc.pp.api.mes.SI_SbmlvZ003API_Out_V1.class.isAssignableFrom(serviceEndpointInterface)) {
                ecc.pp.api.mes.SI_SbmlvZ003API_Out_V1BindingStub _stub = new ecc.pp.api.mes.SI_SbmlvZ003API_Out_V1BindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ecc/pp/api/mes", "SI_SbmlvZ003API_Out_V1Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ecc/pp/api/mes", "HTTPS_Port"));
            ports.add(new javax.xml.namespace.QName("http://ecc/pp/api/mes", "HTTP_Port"));
        }
