...
<body onload="editable()">
	...
	<div class="container-fluid mycontainer">
		<h3>
			<span class="label label-success">工位维护</span>
		</h3>
		<div class="col-xs-12">
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="exampleModalLabel">工位新增</h4>
								</div>
								<form action="SaveWorkStation" method="post">
									<div class="modal-body">
										<div class="form-group">
											<label for="recipient-name" class="control-label">请选择工位所在产线名称</label>
											<select id="process_line" name="processline_id"
												class="form-control">
												<option value="">请选择产线</option>
											</select>
										</div>
										<div class="form-group">
											<label for="recipient-name" class="control-label">请选择工位所在工艺过程</label>
											<select id="method_process" name="methodprocess_id"
												class="form-control">
												<option value="">请选择工艺过程</option>
											</select>
										</div>
										<div class="form-group">
											<label for="recipient-name" class="control-label">请输入工位编号</label>
											<input type="text" class="form-control" id="recipient-name"
												name="workstation_id">
										</div>
										<div class="form-group">
											<label for="recipient-name" class="control-label">请输入工位名称</label>
											<input type="text" class="form-control" id="recipient-name"
												name="name">
										</div>
									</div>
	...
	var lang = navigator.language || navigator.userLanguage;
		...
		var oTableInit;
		var tableConfig = {
			url : '/Otracking/GetWorkStation', //请求后台的URL（*）
			method : 'get', //请求方式（*）
		...
		$(function() {
			var sltProcessLine = document.getElementById("process_line");
			$.ajax({
