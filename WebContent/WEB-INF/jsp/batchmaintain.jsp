...
<body onload="editable()">
	...
	<div class="container-fluid mycontainer">
		<h3>
			<span class="label label-success">Batch维护</span>
		</h3>
			...
			<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form action="SaveBatchByExcel" method="post" enctype="multipart/form-data">
	...
	var lang = navigator.language || navigator.userLanguage;
		...
		var tableConfig = {
			url : '/Otracking/GetBatch?limit=1', //请求后台的URL（*）
			method : 'get', //请求方式（*）
			...
			columns : [ {
				...
				field : 'drawer_quantity',
				title : '抽屉',
			}, {
				field : 'accessory_case_quantity',
				title : '附件箱',
			}, /* {
				field : 'outsource',
				title : '外包',
