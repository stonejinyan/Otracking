...
<body onload="editable()">
	...
	<div class="container-fluid mycontainer">
		<h3>
			<span class="label label-success">产品小类维护</span>
		</h3>
		<div class="col-xs-12">
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="exampleModalLabel">产品小类新增</h4>
								</div>
								<form action="SaveSmallType" method="post">
									<div class="modal-body">
										<div class="form-group">
											<label for="recipient-name" class="control-label">请选择产品小类所在产品大类的名称（确保产品小类具有完成相同的工艺过程）</label>
											<select id="bigtype" name="bigtype_id"
												class="form-control">
												<option value="">请选择产品大类</option>
											</select>
										</div>
										<div class="form-group">
											<label for="recipient-name" class="control-label">请输入产品小类名称</label>
	...
	var lang = navigator.language || navigator.userLanguage;
		...
		var oTableInit;
		var tableConfig = {
			url : '/Otracking/GetSmallType', //请求后台的URL（*）
			method : 'get', //请求方式（*）
		...
		$(function() {
			var sltProcessLine = document.getElementById("bigtype");
			$.ajax({
				url : '/Otracking/GetBigType',
				type : 'GET',
