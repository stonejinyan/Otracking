...
<body onload="editable()">
	...
	<div class="container-fluid mycontainer">
		<h3>
			<span class="label label-success">关键物料维护</span>
		</h3>
		<div class="col-xs-12">
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="exampleModalLabel">关键物料新增</h4>
								</div>
								<form action="SaveKeyComponents" method="post">
									<div class="modal-body">
										<div class="form-group">
											<label for="recipient-name" class="control-label">请输入关键物料编码</label>
									...
									<div class="modal-body">
										<div class="form-group">
											<label for="recipient-name" class="control-label">请输入关键物料名称</label>
											<input type="text" class="form-control" id="recipient-name"
												name="name">
										</div>
									</div>
	...
	var $table = $('#table'), $button = $('#btn_edit');
		...
		var tableConfig = {
			url : '/Otracking/GetKeyComponents', //请求后台的URL（*）
			method : 'get', //请求方式（*）
