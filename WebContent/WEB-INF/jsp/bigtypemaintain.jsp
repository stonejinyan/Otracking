...
<body onload="editable()">
	...
	<div class="container-fluid mycontainer">
		<h3>
			<span class="label label-success">产品大类维护</span>
		</h3>
		<div class="col-xs-12">
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="exampleModalLabel">产品大类新增</h4>
								</div>
								<form action="BigTypeSave" method="post">
									<div class="modal-body">
										<div class="form-group">
											<label for="recipient-name" class="control-label">请输入产品类型</label>
	...
	var $table = $('#table'), $button = $('#btn_edit');
		...
		var tableConfig = {
			url : '/Otracking/GetBigType', //请求后台的URL（*）
			method : 'get', //请求方式（*）
