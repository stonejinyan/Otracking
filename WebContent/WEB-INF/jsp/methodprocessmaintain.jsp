...
<body onload="editable()">
	...
	<div class="container-fluid mycontainer">
		<h3>
			<span class="label label-success">工艺过程维护</span>
		</h3>
		<div class="col-xs-12">
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="exampleModalLabel">工艺过程新增</h4>
								</div>
								<form action="SaveMethodProcess" method="post">
									<div class="modal-body">
										<div class="form-group">
											<label for="recipient-name" class="control-label">请选择工艺过程所在产线名称</label>
	...
	var lang = navigator.language || navigator.userLanguage;
		...
		var oTableInit;
		var tableConfig = {
			url : '/Otracking/GetMethodProcess', //请求后台的URL（*）
			method : 'get', //请求方式（*）
