...
<body style="height: 100%; margin: 0">
	...
	<div class="container-fluid mycontainer bs-docs-container">
		<div class="row">
			<div class="col-md-12" role="main">
				...
				<div>
					<h1 id="grunt" class="page-header">异常看板</h1>
					<div class="row">
						<div class="col-xs-8 hr" style="padding-left: 0px;">
							<h3>
								<span class="label label-success">分类占比</span>
							</h3>
							<div id="Abnormal_Type" style="height: 300px"></div>
						</div>
						<div class="col-xs-4">
							<%-- <h3>
								<span class="label label-success">趋势</span>
							</h3> --%>
						</div>
					</div>
					<hr>
					<div class="row">
						<div class="col-xs-12" style="padding-left: 0px;">
							<h3 id="mo">
								<span class="label label-success">异常信息</span>
							</h3>
						</div>
					</div>
					<div id="toolbar">
	...
	<script type="text/javascript">
		var dom = document.getElementById("Abnormal_Type");
		...
		function showEChart() {
			...
			myChart.showLoading();
			$.ajax({
				url : '/Otracking/GetAbnormalTypeCount',
				type : 'GET',
				success : function(Abnormaldata) {
					myChart.setOption({ //加载数据图表                
						legend : {
							data : Abnormaldata.legendData,
							selected : Abnormaldata.selected
						},
						series : [ {
							data : Abnormaldata.seriesData
						}, ]
					});
				}
			});
		...
		var interruptiontableConfig = {
			...
			pageSize : 5, //每页的记录行数（*）
			pageList : [ 5, 15, 25, 40, 80, 100 ], //可供选择的每页的行数（*）
